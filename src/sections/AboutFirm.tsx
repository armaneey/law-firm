...
export function AboutFirm() {
  return (
    <section className="bg-cream py-24">
      <div className="mx-auto max-w-5xl px-6 text-align md:px-10">
        <span className="mb-4 block text-xs font-bold uppercase tracking-[0.3em] text-gold">About Firm</span>
        <h3 className="mx-auto max-w-3xl font-serif text-2xl font-bold leading-snug text-ink md:text-4xl">
